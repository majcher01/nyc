...
<div style='margin-bottom:20px; border-bottom:2px solid black; height:40px; padding: 5px 5px 5px 5px; font-family: Verdana, sans-serif;' >
    <span style='float:left;' class="navel"><a href='/admin' style='text-decoration:none;'>Podsumowanie</a></span>
    <span style='float:left;' class="navel"><a href='/admin/uzytkownicy' style='text-decoration:none;'>Użytkownicy</a></span>
    <span style='float:left;' class="navel"><a href='/admin/wyniki' style='text-decoration:none;'>Wyniki</a></span>
    <span style='float:left;' class="navel"><a href='/admin/pytania' style='text-decoration:none;'>Pytania</a></span>
